  ...
  return (
    <>
      <div className="flex-col background h-screen">
        ...
        {/* Div for Bento Grid */}
        <div className="h-500 w-full flex items-center justify-center bg-black md:h-screen">
          <div
          ...
          >
            ...
            rounded-xl max-md:h-125"
            ></div>
            <div
              className="col-start-1 col-end-4 row-start-4 row-end-5
            rounded-xl grid grid-cols-3 gap-3 max-md:h-50"
            >
            ...
            rounded-xl max-lg:col-start-4 max-lg:col-end-9 max-md:h-65"
            ></div>
            <div
              className="col-start-6 col-end-11 row-start-4 row-end-5 bg-stone-700 
            rounded-xl max-lg:col-start-4 max-lg:col-end-9 max-md:h-30"
            ></div>
            <div
            ...
            rounded-xl max-lg:col-start-5 max-lg:col-end-9 max-md:h-65"
            ></div>
            <div
