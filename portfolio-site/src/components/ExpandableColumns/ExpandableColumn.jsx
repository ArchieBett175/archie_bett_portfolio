...
const ExpandableColumn = ({
  ...
  return (
    <motion.div
      onClick={handleClick}
      className="relative overflow-hidden rounded-lg cursor-pointer bg-gradient-to-br 
        shadow-lg hover:shadow-xl transition-shadow bg-zinc-700 max-h-[490px] md:w-auto md:min-h-0"
      style={{
