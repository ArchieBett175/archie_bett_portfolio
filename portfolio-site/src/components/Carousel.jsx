...
const Carousel = ({ isVisible, items, carouselItem }) => {
        ...
        >
          {items.map((item, index) => (
            <div key={item.id} className="w-full flex-shrink-0">
                {carouselItem === MobileCarouselItem ? <MobileCarouselItem column={item} isActive={index === current} /> : <ImageCarouselItem item={item} alt={item.altText} key={index}/>}
